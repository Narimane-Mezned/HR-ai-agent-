...
async function loadJob() {
  if (!jobId) {
    document.getElementById("apply-job-title").innerText = "Nojob specified";
...
function renderQuestions() {
  ...
  container.innerHTML = `<label style="margin-top:10px;">A fewquick questions</label>`;
